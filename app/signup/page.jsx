...
const Signup = () => {
  ...
  return (
    <form>
      ...
      <input type="text" id='name' name='username' placeholder='Enter Name' className='px-8 rounded text-[14px] w-full h-10 focus:ring-2 focus:ring-[#db2777] outline-none' />
      </div>
      <div className='relative'>
      <Image src="/envelope-solid.svg" alt="User Logo" width={16} height={12} className='absolute top-[60px] left-2'/> &nbsp;
      <input type="email" id='email' name="useremail" placeholder='Enter email' className='px-8 mt-6 rounded text-[14px] w-full h-10 focus:ring-2 focus:ring-[#db2777] outline-none' />
      </div>
      <div className='relative'>
      <Image src="/lock-solid.svg" alt="User Logo" width={14} height={12} className='absolute top-[60px] left-2'/> &nbsp;
      <input type="password" id='password' name='userpassword' placeholder='Enter password' className='px-8 mt-6 rounded text-[14px] w-full h-10 focus:ring-2 focus:ring-[#db2777] outline-none' />
      </div>
